...
import 'package:my_sampad/src/injectable/module_injection/feature/teacher_feature_module.dart'
    as _i118;
import 'package:my_sampad/src/presentation/auth/bloc/auth_bloc.dart' as _i101;
...
import 'package:my_sampad/src/presentation/exam/bloc/exam/exam_bloc.dart'
    as _i104;
import 'package:my_sampad/src/presentation/home/bloc/home_bloc.dart' as _i105;
...
extension GetItInjectableX on _i1.GetIt {
  ...
  _i1.GetIt init({
    ...
    gh.factory<_i34.GetAccountDataUseCase>(
        () => authFeatureModule.getAccountDataUseCase);
    gh.factory<_i35.GetCachedAuthDataUseCase>(
        () => authFeatureModule.getCacheDataUseCase);
    gh.factory<_i36.GetCachedClassroomsDataUseCase>(
        () => classroomFeatureModule.getCachedClassroomDataUseCase);
    gh.factory<_i37.GetCachedCourseDataUseCase>(
        () => courseFeatureModule.getCachedCourseDataUseCase);
    gh.factory<_i38.GetCachedExamDataUseCase>(
        () => examFeatureModule.getCachedExamDataUseCase);
    gh.factory<_i39.GetCachedMediatorDataUseCase>(
        () => mediatorFeatureModule.getCachedMediatorDataUseCase);
    gh.factory<_i40.GetCachedParentDataUseCase>(
        () => parentFeatureModule.getCachedParentDataUseCase);
    gh.factory<_i41.GetCachedRollcallDataUseCase>(
        () => rollcallFeatureModule.getCachedRollcallDataUseCase);
    gh.factory<_i42.GetCachedScoreDataUseCase>(
        () => scoreFeatureModule.getCachedScoreDataUseCase);
    gh.factory<_i43.GetCachedStudentDataUseCase>(
        () => studentFeatureModule.getCachedStudentDataUseCase);
    gh.factory<_i44.GetCachedTeacherDataUseCase>(
        () => teacherFeatureModule.getCachedTeacherDataUseCase);
    gh.factory<_i45.GetClassroomsUseCase>(
        () => classroomFeatureModule.getClassroomsUseCase);
    gh.factory<_i46.GetCoursesUseCase>(
        () => courseFeatureModule.getCoursesUseCase);
    gh.factory<_i47.GetExamsUseCase>(() => examFeatureModule.getExamsUseCase);
    gh.factory<_i48.GetMediatorUseCase>(
        () => mediatorFeatureModule.getMediatorsUseCase);
    gh.factory<_i49.GetParentUseCase>(
        () => parentFeatureModule.getParentsUseCase);
    gh.factory<_i50.GetRollCallsUseCase>(
        () => rollcallFeatureModule.getRollcallsUseCase);
    gh.factory<_i51.GetSchoolsUseCase>(
        () => schoolFeatureModule.getSchoolsUseCase);
    gh.factory<_i52.GetScoreUseCase>(() => scoreFeatureModule.getScoresUseCase);
    gh.factory<_i53.GetStudentParentUseCase>(
        () => studentFeatureModule.getStudentParentUseCase);
    gh.factory<_i54.GetStudentUseCase>(
        () => studentFeatureModule.getStudentsUseCase);
    gh.factory<_i55.GetTeacherClassroomsUseCase>(
        () => classroomFeatureModule.getTeacherClassroomDataUseCase);
    gh.factory<_i56.GetTeacherUseCase>(
        () => teacherFeatureModule.getTeachersUseCase);
    gh.factory<_i57.LogoutAuthDataUseCase>(
        () => authFeatureModule.logoutAuthDataUseCase);
    gh.factory<_i58.MediatorLocalDataSource>(
        () => mediatorFeatureModule.localDS);
    gh.factory<_i59.MediatorRemoteDataSource>(
        () => mediatorFeatureModule.remoteDS);
    gh.factory<_i60.MediatorRepository>(() => mediatorFeatureModule.repo);
    gh.factory<_i61.OtpHandshakeUseCase>(
        () => authFeatureModule.otpAuthorizaUseCase);
    gh.factory<_i62.ParentLocalDataSource>(() => parentFeatureModule.localDS);
    gh.factory<_i63.ParentRemoteDataSource>(() => parentFeatureModule.remoteDS);
    gh.factory<_i64.ParentRepository>(() => parentFeatureModule.repo);
    gh.factory<_i65.RemoveClassroomUseCase>(
        () => classroomFeatureModule.removeClassroomUseCase);
    gh.factory<_i66.RemoveCourseUseCase>(
        () => courseFeatureModule.removeCourseUseCase);
    gh.factory<_i67.RemoveExamUseCase>(
        () => examFeatureModule.removeExamUseCase);
    gh.factory<_i68.RemoveMediatorUseCase>(
        () => mediatorFeatureModule.removeMediatorUseCase);
    gh.factory<_i69.RemoveScoreUseCase>(
        () => scoreFeatureModule.removeScoreUseCase);
    gh.factory<_i70.RemoveStudentUseCase>(
        () => studentFeatureModule.removeStudentUseCase);
    gh.factory<_i71.RemoveTeacherUseCase>(
        () => teacherFeatureModule.removeTeacherUseCase);
    gh.factory<_i72.RequestInterceptor>(() => _i72.RequestInterceptor());
    gh.lazySingleton<_i73.RollcallBloc>(
        () => _i73.RollcallBloc(gh<_i50.GetRollCallsUseCase>()));
    gh.factory<_i74.RollcallLocalDataSource>(
        () => rollcallFeatureModule.localDS);
    gh.factory<_i75.RollcallRemoteDataSource>(
        () => rollcallFeatureModule.remoteDS);
    gh.factory<_i76.RollcallRepository>(() => rollcallFeatureModule.repo);
    gh.lazySingleton<_i77.SchoolBloc>(
        () => _i77.SchoolBloc(gh<_i51.GetSchoolsUseCase>()));
    gh.factory<_i78.SchoolRemoteDataSource>(() => schoolFeatureModule.remoteDS);
    gh.factory<_i79.SchoolRepository>(() => schoolFeatureModule.repo);
    gh.factory<_i80.ScoreBloc>(() => _i80.ScoreBloc(
          gh<_i52.GetScoreUseCase>(),
          gh<_i69.RemoveScoreUseCase>(),
        ));
    gh.factory<_i81.ScoreBoardBloc>(() => _i81.ScoreBoardBloc(
          gh<_i54.GetStudentUseCase>(),
          gh<_i8.AddScoreUseCase>(),
        ));
    gh.factory<_i82.ScoreLocalDataSource>(() => scoreFeatureModule.localDS);
    gh.factory<_i83.ScoreRemoteDataSource>(() => scoreFeatureModule.remoteDS);
    gh.factory<_i84.ScoreRepository>(() => scoreFeatureModule.repo);
    gh.lazySingleton<_i85.SplashBloc>(() => _i85.SplashBloc(
          gh<_i35.GetCachedAuthDataUseCase>(),
          gh<_i34.GetAccountDataUseCase>(),
        ));
    gh.factory<_i86.StudentLocalDataSource>(() => studentFeatureModule.localDS);
    gh.factory<_i87.StudentRemoteDataSource>(
        () => studentFeatureModule.remoteDS);
    gh.factory<_i88.StudentRepository>(() => studentFeatureModule.repo);
    gh.lazySingleton<_i89.TeacherClassroomBloc>(() =>
        _i89.TeacherClassroomBloc(gh<_i55.GetTeacherClassroomsUseCase>()));
    gh.lazySingleton<_i90.TeacherDetailBloc>(() => _i90.TeacherDetailBloc(
          gh<_i48.GetMediatorUseCase>(),
          gh<_i6.AddMediatorUseCase>(),
          gh<_i68.RemoveMediatorUseCase>(),
        ));
    gh.factory<_i91.TeacherLocalDataSource>(() => teacherFeatureModule.localDS);
    gh.factory<_i92.TeacherRemoteDataSource>(
        () => teacherFeatureModule.remoteDS);
    gh.factory<_i93.TeacherRepository>(() => teacherFeatureModule.repo);
    gh.factory<_i94.UpdateClassroomUseCase>(
        () => classroomFeatureModule.updateClassroomUseCase);
    gh.factory<_i95.UpdateCourseUseCase>(
        () => courseFeatureModule.updateCourseUseCase);
    gh.factory<_i96.UpdateExamUseCase>(
        () => examFeatureModule.updateExamUseCase);
    gh.factory<_i97.UpdateParentUseCase>(
        () => parentFeatureModule.updateParentUseCase);
    gh.factory<_i98.UpdateScoreUseCase>(
        () => scoreFeatureModule.updateScoreUseCase);
    gh.factory<_i99.UpdateStudentUseCase>(
        () => studentFeatureModule.updateStudentUseCase);
    gh.factory<_i100.UpdateTeacherUseCase>(
        () => teacherFeatureModule.updateTeacherUseCase);
    gh.factory<_i101.AuthBloc>(() => _i101.AuthBloc(
          gh<_i61.OtpHandshakeUseCase>(),
          gh<_i14.CacheAuthDataUseCase>(),
          gh<_i57.LogoutAuthDataUseCase>(),
        ));
    gh.lazySingleton<_i102.ClassroomBloc>(() => _i102.ClassroomBloc(
          gh<_i45.GetClassroomsUseCase>(),
          gh<_i3.AddClassroomUseCase>(),
          gh<_i55.GetTeacherClassroomsUseCase>(),
          gh<_i94.UpdateClassroomUseCase>(),
          gh<_i65.RemoveClassroomUseCase>(),
        ));
    gh.lazySingleton<_i103.CourseBloc>(() => _i103.CourseBloc(
          gh<_i46.GetCoursesUseCase>(),
          gh<_i4.AddCourseUseCase>(),
          gh<_i95.UpdateCourseUseCase>(),
          gh<_i66.RemoveCourseUseCase>(),
        ));
    gh.lazySingleton<_i104.ExamBloc>(() => _i104.ExamBloc(
          gh<_i47.GetExamsUseCase>(),
          gh<_i5.AddExamUseCase>(),
          gh<_i67.RemoveExamUseCase>(),
          gh<_i96.UpdateExamUseCase>(),
        ));
    gh.factory<_i105.HomeBloc>(
        () => _i105.HomeBloc(gh<_i57.LogoutAuthDataUseCase>()));
    gh.lazySingleton<_i106.StudentBloc>(() => _i106.StudentBloc(
          gh<_i54.GetStudentUseCase>(),
          gh<_i9.AddStudentUseCase>(),
          gh<_i53.GetStudentParentUseCase>(),
          gh<_i99.UpdateStudentUseCase>(),
          gh<_i70.RemoveStudentUseCase>(),
        ));
    gh.lazySingleton<_i107.TeacherBloc>(() => _i107.TeacherBloc(
          gh<_i56.GetTeacherUseCase>(),
          gh<_i10.AddTeacherUseCase>(),
          gh<_i100.UpdateTeacherUseCase>(),
          gh<_i71.RemoveTeacherUseCase>(),
        ));
    return this;
  }
}

class _$AuthFeatureModule extends _i108.AuthFeatureModule {}

class _$ClassroomFeatureModule extends _i109.ClassroomFeatureModule {}

class _$CourseFeatureModule extends _i110.CourseFeatureModule {}

class _$ExamFeatureModule extends _i111.ExamFeatureModule {}

class _$MediatorFeatureModule extends _i112.MediatorFeatureModule {}

class _$ParentFeatureModule extends _i113.ParentFeatureModule {}

class _$RollcallFeatureModule extends _i114.RollcallFeatureModule {}

class _$SchoolFeatureModule extends _i115.SchoolFeatureModule {}

class _$ScoreFeatureModule extends _i116.ScoreFeatureModule {}

class _$StudentFeatureModule extends _i117.StudentFeatureModule {}

class _$TeacherFeatureModule extends _i118.TeacherFeatureModule {}
