...
import 'package:my_sampad/src/features/role_call/domain/failure/rollcall_failure.dart';
import 'package:my_sampad/src/features/role_call/domain/models/rollcall_get_response.dart';
import 'package:my_sampad/src/features/role_call/domain/repositories/rollcall_repository.dart';

class GetCachedRollcallDataUseCase
    implements UseCase<RollcallFailure, RollcallGetResponse, tuple.Tuple0> {
